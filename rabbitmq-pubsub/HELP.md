...
* The original package name 'com.rajeev.rabbitmq-pubsub' is invalid and this project uses 'com.rajeev.rabbitmq_pubsub' instead.
...
* [Spring for RabbitMQ](https://docs.spring.io/spring-boot/3.3.11/reference/messaging/amqp.html)
